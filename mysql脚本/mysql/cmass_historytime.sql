...
DROP TABLE IF EXISTS `historytime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historytime` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `start` char(45) DEFAULT NULL,
  `end` char(45) DEFAULT NULL,
...
LOCK TABLES `historytime` WRITE;
/*!40000 ALTER TABLE `historytime` DISABLE KEYS */;
/*!40000 ALTER TABLE `historytime` ENABLE KEYS */;
UNLOCK TABLES;
