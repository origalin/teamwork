...
public class DriverAdd extends JPanel {
	...
	public DriverAdd() {
		...
		gridBagLayout.rowHeights = new int[]{56, 252, 0};
		...
		JLabel label = new JLabel("\u65B0\u589E/\u4FEE\u6539\u53F8\u673A\u4FE1\u606F");
		panel.add(label);
		...
		gbl_panel_1.columnWidths = new int[]{0, 0, 151, 26, 56, 149, 0, 0};
		gbl_panel_1.rowHeights = new int[]{9, 0, 0, 2, 0, 0, 0, 0};
		...
		JLabel label_6 = new JLabel("\u884C\u9A76\u8BC1\u671F\u9650");
